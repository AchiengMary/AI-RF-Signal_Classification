...
AM, FM, Bluetooth, WiFi, Zigbee, Radar, LTE, Noise
...
Capture IQ data with RTL-SDR

Apply filtering + STFT

Convert to spectrogram (224×224)

Run model inference

Display probabilities + detected signals
